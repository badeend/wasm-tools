    ...
    (component
      (type (;0;)
        (instance
          ...
          (type (;9;) (func (param "self" 7) (result u32)))
          (export (;3;) "[get]bar.c" (func (type 9)))
          (type (;10;) (func (param "self" 7) (param "value" u32)))
          (export (;4;) "[set]bar.d" (func (type 10)))
          (type (;11;) (func (param "x" 4) (result 4)))
          (export (;5;) "a" (func (type 11)))
        )
      )
